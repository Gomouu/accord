 ...
 * (Fait depuis : les deux plafonds ci-dessous suivent désormais leur fichier.)
 *
 ...
 */
const DETTE = new Map([
  ["crates/accord-core/src/group/state.rs", 1784],
  ["crates/accord-proto/src/core_msg.rs", 2800],
  ["crates/accord-node/src/runtime.rs", 3169],
  ["crates/accord-node/src/voice/engine.rs", 1905],
  ["crates/accord-node/src/node/mod.rs", 2853],
  ["crates/accord-node/src/node/groups.rs", 2600],
  ["app/src/lib/api.ts", 2738],
  ["crates/accord-transport/src/endpoint.rs", 2447],
  ["crates/accord-core/src/group/msg.rs", 800],
  ["crates/accord-node/src/maintenance.rs", 1193],
  ["app/src/stores/groups.ts", 1301],
  ["crates/accord-core/src/group/invite.rs", 760],
  ["crates/accord-core/src/db/messages.rs", 1013],
  ["crates/accord-core/src/db/mod.rs", 955],
  ["crates/accord-node/src/voice/calls.rs", 844],
  ["crates/accord-core/src/profile.rs", 669],
  ["app/src/components/MessageInput.tsx", 1267],
  ["crates/accord-node/src/device.rs", 421],
  ["app/src/stores/ui.ts", 1154],
  ["crates/accord-node/src/node/dm.rs", 623],
  ...
  ["crates/accord-core/src/group/mod.rs", 477],
  ["app/src/components/Sidebar.tsx", 1078],
  ["crates/accord-node/src/backup.rs", 538],
  ["crates/accord-core/src/messaging.rs", 479],
  ["app/src/components/MessageList.tsx", 921],
  ["crates/accord-node/src/lib.rs", 794],
  ["crates/accord-node/src/node/profile.rs", 392],
  ["crates/accord-core/src/friends.rs", 445],
]);
