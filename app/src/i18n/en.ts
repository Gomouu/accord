...
export const en: Dict = {
  ...
  dmGroups: {
    ...
    createHint: 'Three to twenty people, one thread — without creating a server.',
    namePlaceholder: 'Group name',
    searchPlaceholder: 'Search a friend',
    selected: '{count} of {max} selected',
    needMore: 'Pick at least two friends: with one, a direct message is enough.',
    createAction: 'Create group',
    noFriends: 'Add friends to create a group.',
    noResults: 'No friend matches.',
    empty: 'No group yet.',
    memberCount: '{count} members',
    settings: 'Group settings',
    anyoneCanEdit: 'Any member can rename the group, change its icon and leave.',
    ...
    you: 'you',
    leave: 'Leave group',
    leaveConfirm: 'Leave “{name}”? You will stop receiving its messages.',
  ...
  automod: {
    hint: 'Filtered words are masked at display time on members’ clients (serverless model: nothing is removed from the network). Lowercase words, up to {chars} characters, {max} words at most.',
    count: 'Filtered words — {count}/{max}',
    ...
    wordTooLong: 'Word too long ({max} characters max).',
    limitReached: '{max} words at most.',
    save: 'Save',
